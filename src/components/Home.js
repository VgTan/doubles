  ...
  return (
    <div>
      ...
      <div className="font-poppins">
        <div>
          {/* Experience */}
          <div className="autoshow-anim 20 xl:mx-44 my-10 flex flex-col lg:flex-row justify-between">
          ...
          <div className="bg-[#0A4251] text-center py-12 ">
            <div className="mx-5 md:mx-10 lg:mx-20 mt-10 mb-10 autoshow-anim">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center md:justify-evenly space-y-8 md:space-y-0 md:space-x-12">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-white mt-4 text-sm md:text-base">
                    ...
                    ensuring every frame tells your story beautifully.
                  </p>
                </div>
                <div className="flex flex-col items-center mt-8 md:mt-0">
                  ...
                  <p className="text-white mt-4 text-sm md:text-base">
                    ...
                    stunning graphics for social media, ads, and more, tailored
                ...
                <div className="flex flex-col items-center mt-8 md:mt-0">
                  ...
                  <p className="text-white mt-4 text-sm md:text-base">
                    ...
                    visibility, delivering clear and engaging messages to your
                    audience.
                  </p>
                </div>
              </div>
          ...
          <div className="text-center py-12 overflow-hidden">
            <div className="mt-10 mb-10">
              <h2 className="text-3xl md:text-5xl font-extrabold text-[#0A4251] mb-4 autoshow-anim">
                Our Work
              </h2>
              <p className="text-lg md:text-xl text-[#0A4251] mt-2 mb-8 autoshow-anim">
                Take A Look At Our Previous Work
              </p>
              <div className="list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                <div
                  ref={elementRef}
          ...
          {/* Our Packages */}
          <div className="text-center py-12 font-poppins overflow-hidden">
            <div className="mx-36 mb-10">
              ...
              <div className="flex flex-col overflow-hidden">
                <div className="bg-[#fce6b9d2] h-30 p-8 relative">
                  <div
                    ref={(el) => (elementsRef.current[0] = el)}
                    className="bg-white left-0 top-0 right-0 bottom-0 h-30 w-full absolute typeAnim"
                  ></div>
                  <div className="flex flex-wrap text-wrap items-center pl-8">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      className="bi bi-tiktok w-8 h-8 text-[#0A4251]"
                      viewBox="0 0 16 16"
                    >
                      <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z" />
                    </svg>
                    <p className="overflow-hidden text-4xl text-[#0A4251] font-semibold pl-3 pr-32">
                      Tiktok
                    </p>
                    <p className="text-sm text-[#0A4251] text-left w-3/4 font-medium">
                ...
                <div className="bg-[#ff8c9295] h-30 p-8 w-11/12 relative">
                  <div
                    ref={(el) => (elementsRef.current[1] = el)}
                    className="bg-white left-0 top-0 right-0 bottom-0 h-30 w-full absolute typeAnim"
                  ></div>
                  <div className="flex text-wrap flex-wrap items-center pl-8">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      className="bi bi-instagram w-9 h-9 text-[#0A4251]"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="bg-[#0a425158] h-30 p-8 w-10/12 relative">
                  <div
                  ...
                  <div className="flex text-wrap flex-wrap items-center pl-8">
                    <svg
                      className="w-12 h-12 text-[#0A4251] bi bi-images"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 16 16"
                    >
                    ...
                    <p className="overflow-hidden text-4xl text-[#0A4251] font-semibold pl-3 pr-32 text-nowrap">
                      Graphic Design
                    </p>
                    <p className="text-sm text-[#0A4251] text-left w-3/4 font-medium">
                ...
                <div className="bg-[#ffd87485] h-30 p-8 w-11/12 relative">
                  <div
                  ...
                  <div className="flex text-wrap flex-wrap items-center pl-8">
                    <svg
                      className="w-14 h-14 text-[#0A4251] bi bi-camera2"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="bg-[#e87171c4] h-30 p-8 relative">
                  <div
                  ...
                  <div className="flex text-wrap flex-wrap items-center pl-8">
                    <svg
                      className="w-14 h-14 text-[#0A4251] bi bi-megaphone-fill"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 16 16"
                    >
                    ...
                    <div className="flex flex-row gap-4 md:gap-8 text-center justify-between">
                      <div>
                        <span
                          ...
                          data-val="48"
                          className="countNum text-4xl md:text-6xl text-[#0A4251] font-bold"
                        >
                          0+
                        </span>
                        <p className="text-lg md:text-2xl text-[#0A4251]">
          ...
          <div className="text-center py-12 font-poppins mt-16 mb-10">
            <div className="mx-32 mb-10">
              <h2 className="text-5xl font-extrabold text-[#0A4251] autoshow-anim">
                Our Client
              </h2>
              <p className="text-xl text-[#0A4251] mt-2 mb-16 autoshow-anim">
