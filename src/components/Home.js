  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      valuesRef.current.forEach((element) => {
        ...
        if (
          valTop < innerHeight &&
          !element.classList.contains("countNumStart")
        ) {
    ...
    <div>
      ...
      <div className="font-poppins">
        <div>
          {/* Experience */}
          <Reveal>
            <div className="transition duration-1000 mx-8 xl:mx-44 my-10 flex flex-col lg:flex-row justify-between">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:justify-evenly space-y-8 md:space-y-0 md:space-x-12">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-white mt-4 text-xs md:text-base">
                      At Double S, we create engaging video content that
                      captures your brand's essence and drives audience
                      engagement. Our skilled team handles everything from
                      concept to final edits.
                    </p>
                  </div>
                  <div className="flex flex-col items-center mt-8 md:mt-0">
                    ...
                    <p className="text-white mt-4 text-xs md:text-base">
                      ...
                      out. We combine creativity and strategy to produce
                      visually stunning graphics for social media, ads, and
                      more.
                    </p>
                  </div>
                  <div className="flex flex-col items-center mt-8 md:mt-0">
            ...
            <div className="text-center py-12 overflow-hidden">
              <div className="mt-10 mb-10">
                ...
                <div className="list grid grid-cols-2 lg:grid-cols-4 gap-5">
                  <div
                    ref={elementRef}
                    className="list relative w-full overflow-hidden bg-cover bg-no-repeat scale-0 h-[18rem]"
                  >
              ...
              <div className="mx-10 md:mx-36 mb-10">
                ...
                <div className="flex flex-col overflow-hidden">
                  <div className="bg-[#fce6b9d2] h-30 p-5 md:p-8 relative">
                    ...
                    ></div>
                    <div className="flex flex-wrap md:flex-nowrap items-center pl-4 sm:pl-4 md:pl-6">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                      ...
                      <p className="overflow-hidden text-xl text-[#0A4251] font-semibold pl-3 pr-4 sm:pr-8 md:pr-12">
                        Tiktok
                      </p>
                  ...
                  <div className="bg-[#0a425158] h-30 p-5 md:p-8 md:w-10/12 relative">
                    ...
                    <div className="flex flex-wrap md:flex-nowrap items-center pl-4 sm:pl-4 md:pl-6">
                      <svg
                        className="h-6 w-6 md:w-10 md:h-10 text-[#0A4251] bi bi-images"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 16 16"
                      >
                      ...
                      <p className="overflow-hidden text-xl text-[#0A4251] font-semibold pl-3 md:pr-12 text-nowrap">
                        Graphic Design
                      </p>
                      <p className="text-xs md:text-sm text-[#0A4251] text-left w-full md:w-3/4 font-medium mt-2 md:mt-0">
                        From feeds creation to marketing materials, our graphic
                        design package brings your vision to life with
                        creativity and precision, aligning every design element
                  ...
                  <div className="bg-[#ffd87485] h-30 p-5 md:p-8 w-11/12 relative">
                    ...
                    <div className="flex flex-wrap md:flex-nowrap items-center pl-4 sm:pl-4 md:pl-6">
                      <svg
                        className="w-7 h-7 md:w-10 md:h-10 text-[#0A4251] bi bi-camera2"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 16 16"
                      >
                      ...
                      <p className="text-xs md:text-sm text-[#0A4251] text-left w-full md:w-3/4 font-medium mt-2 md:mt-0">
                        Our photography package offers professional photo
                        shoots, product photography, and lifestyle imagery,
                        capturing stunning visuals that reflect your brand's
                  ...
                  <div className="bg-[#e87171c4] h-30 p-5 md:p-8 relative">
                    ...
                    <div className="flex flex-wrap md:flex-nowrap items-center pl-4 sm:pl-4 md:pl-6">
                      <svg
                        className="w-6 h-6 md:w-10 md:h-10 text-[#0A4251] bi bi-megaphone-fill"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 16 16"
                      >
                      ...
                      <p className="overflow-hidden text-md text-[#0A4251] font-semibold pl-3 md:pr-12 text-nowrap">
                        Branding & Campaign
                      </p>
                      <p className="text-xs md:text-sm text-[#0A4251] text-left w-full md:w-3/4 font-medium mt-2 md:mt-0">
                        Our branding and campaign package includes graphic
                        design, brand strategy, and marketing campaigns to boost
                        your brand's recognition and drive customer engagement.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-start col-start-3 md:col-start-3 col-span-1 md:col-span-3">
                  <div className="flex flex-col pl-0 md:pl-12 md:pb-10 xl:pb-0">
                    <div className="mb-4 md:mb-10">
                      <p className="text-md md:text-2xl text-[#0A4251] text-center md:text-left">
                        Discover what our clients have to say about working with
                        us.
                      </p>
                    </div>
                    <div className="flex flex-row gap-4 md:gap-8 text-center justify-evenly md:justify-between">
                      <div>
                        <span
