...
function About() {
  return (
    <div className="mx-44 mt-20 font-poppins">
      <div className="flex flex-col text-center mb-5">
        <h2 className="text-5xl font-extrabold text-[#0A4251]">Our Team</h2>
        <p className="text-xl text-[#0A4251] mt-2 mb-16">
          Get To Know The Talented Individuals Behind Our Success
        </p>
      </div>

      <div className="flex mb-8 space-x-4 justify-between items-start">
        <div className="flex w-2/4 flex-wrap pr-10">
          ...
          <p className="text-lg mb-4 text-[#0A4251]">
            ...
            Communications, Especially In Managing The Brand's Social Media For
            3 Years.
          </p>
      ...
      <div className="grid grid-cols-4 gap-10 mt-4">
        <div className="">
          <h1 class="text-6xl tracking-wider font-bold text-[#0A4251] strokeme">
            01
          </h1>
          ...
          <div class="mb-5">
            ...
            <p class="text-xl text-gray-500">Skincare</p>
          </div>
        </div>
        ...
        <div className="mt-28">
          <div class="mb-5">
            ...
            <p class="text-xl text-gray-500">Clothing</p>
          </div>
          <div class="mt-5 mb-5 hover-container">
            <img
              src="./images/via2.png"
        ...
        <div className="">
          ...
          <div class="mb-5">
            ...
            <p class="text-xl text-gray-500">News & Marketing</p>
          </div>
        </div>
        ...
        <div className="mt-28">
          <div class="mb-5">
            ...
            <p class="text-xl text-gray-500">Footwear</p>
          </div>
          <div class="mt-5 mb-5 hover-container">
            <img
              src="./images/via4.png"
